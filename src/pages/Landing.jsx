...
const BG_IMAGE =
"https://media.base44.com/images/public/69efce5d0ae5b56b9b62e666/74f94693a_generated_095a713b.png";

const LOGO_URL =
"https://barel-group.co.il/wp-content/uploads/2025/07/Group-164097.png";
...
const QUESTIONS = [
 ...
 { key: "question_6", text: "האם יש עיקולים, הגבלות, הוצאה לפועל או חובות כלשהם?", type:"choice", options:["כן","לא"]},
...
export default function Landing(){
 ...
 shouldSkipStep2()?TOTAL_STEPS-1:TOTAL_STEPS;

 const effectiveCurrentStep=
 shouldSkipStep2() && currentStep>=3
 ? currentStep-1
 : currentStep;
...
<div
className="fixed top-0 left-0 right-0 z-40 flex justify-center items-center py-3"
style={{
